  ...
  upload(req, res, function(err) {
    ...
    try {
      ...
      if(dataLists.length <= 1) {
         ...
         */
        if(typeof dataLists[0].col01 != "undefined" && typeof dataLists[0].col02 != "undefined" && typeof dataLists[0].col03 != "undefined") {
 ...
 * 2019-09-06  bkLove(촤병국)
 */
function fn_excel_record_check(
  p_param = {
    p_column_check: true,
    p_record_check: true,
    p_rebalance_file_yn: "0",
    p_index: 0,
    p_startIndex: 0,
    p_time_series_yn: "0"
  }, p_record_data = {}) {
 ...
 * 2019-09-06  bkLove(촤병국)
 */
function fn_excel_column_check(
  p_param = {
    p_column_check: true,
    p_column: "",
    p_rebalance_file_yn: "0",
  ...
  upload(req, res, function(err) {
    ...
    try {
      ...
      if(dataLists.length <= 1) {
        ...
        /* 비어 있는 열이 존재하는지 체크 */
        if((typeof dataLists[0].col01 == "undefined" || dataLists[0].col01 == "") || (typeof dataLists[0].col02 == "undefined" || dataLists[0].col02 == "")) {
          v_param.p_record_check = false;
          resultMsg.result = false;
                    ...
                    conn.query(stmt, function(err, rows) {
                      ...
                      if(rows && rows.length > 0) {
                        ...
                        for(var i = 0; i < dataLists.length; i++) {
                          ...
                          var v_index = -1;
                          var v_bm = {};
                          v_daily.RETURN_VAL = Number(simulModule.fn_calc_data("RETURN_VAL", {}, {
                            INDEX_RATE: v_daily.INDEX_RATE /* 당일 지수 */ ,
                            BEFORE_INDEX_RATE: v_prev_daily.INDEX_RATE /* 전일 지수 */
                          }));
                          v_index = _.findIndex(rows, {
                            "F12506": v_daily.F12506
                          });
                          if(v_index > -1) {
