...
var saveBaicInfo = function(req, res) {
    try {
        ...
        var v_arrRebalanceDate          =   {};         /* 리밸런싱 일자 정보 */
        ...
        Promise.using(pool.connect(), conn => {
            ...
            conn.beginTransaction(txerr => {
                ...
                async.waterfall([
                    ...
                    /* 13. 저장시 입력했던 정보로 start_year 기준 직전 영업일 하루 데이터를 조회한다. */
                    function(msg, callback) {
        ...
        Promise.using(pool.connect(), conn => {
            ...
            conn.beginTransaction(txerr => {
                ...
                async.waterfall([
                    ...
                    /* 3. scen_cd 에 존재하면서 start_year 기준 직전 영업일 하루 데이터를 조회한다. */
                    function(msg, callback) {
                    ...
                    /* 4. scen_cd 에 존재하면서 start_year 기준 이력 데이터를 조회한다. */
                    function(msg, callback) {
                    ...
                    /* 5. (백테스트) tm_simul_result_daily 결과를 삭제한다. */
                    function(msg, callback) {
                    ...
                    /* 6. (백테스트) tm_simul_result_daily 결과를 저장한다. */
                    function(msg, callback) {
...
//                                                log.debug(stmt);
                    ...
                    /* 7. (백테스트) tm_simul_result_rebalance 결과를 삭제한다. */
                    function(msg, callback) {
                    ...
                    /* 8. (백테스트) tm_simul_result_rebalance 결과를 저장한다. */
                    function(msg, callback) {
...
*************************************************************************************/
                    /* 9. (백테스트) tm_simul_result 결과를 삭제한다. */
                    function(msg, callback) {
            ...
            if( p_simul_hist_data.length > 0 ) {
                ...
                **************************************************************************************************************/
                if( p_arrFirstHist.length > 0 && p_arrFirstHist[0].F12506 ) {
                    ...
                    *   -   최초 레코드 이전 영업일 인 경우 first_oper_yn   :   'Y' 로 설정한다.
                    **************************************************************************************************************/                   
                    if( [ "1", "3" ].includes( v_dailyObj[ p_arrFirstHist[0].F12506 ].importance_method_cd ) ) {
                        fn_set_siga_sum(
                                {       
                                        F12506          :   p_arrFirstHist[0].F12506    /* 입회일자 */
                ...
                **************************************************************************************************************/             
                ...
                if( p_param.first_oper_yn   ==  "Y" ) {
                    ...
                    if( "2" == v_portItem.importance_method_cd ) {
                        ...
                        p_dailyJongmokObj[ p_param.F12506 ][ v_portKey ].F15028_3    =     fn_calc_data( 
                            "F15028_3"
                            ,   { 
                        ...
                        p_dailyJongmokObj[ p_param.F12506 ][ v_portKey ].F15028_1    =     p_dailyJongmokObj[ p_param.F12506 ][ v_portKey ].F15028_3;

                        /* 시가기준 시총 = 상장주식수(p_param.F16143) * 기준가(p_param.F15007) */
                        p_dailyJongmokObj[ p_param.F12506 ][ v_portKey ].F15028_2    =     p_dailyJongmokObj[ p_param.F12506 ][ v_portKey ].F15028_3;
                    ...
                    /* 상장일이 존재하는 경우 */
                    if( p_dailyJongmokObj[ p_param.F12506 ][ v_portKey ].F16017 ) {

                        /* 상장일 기준 리밸런싱 일자 조회 */
                        for( var j=0; j < p_arrRebalanceDate.length; j++ ) {
                            if( p_arrRebalanceDate[j].F12506 >= p_dailyJongmokObj[ p_param.F12506 ][ v_portKey ].F16017 ) {  
                                p_dailyJongmokObj[ p_param.F12506 ][ v_portKey ].rebalance_F12506       =   p_arrRebalanceDate[j].F12506;
//                                p_dailyJongmokObj[ p_param.F12506 ][ v_portKey ].prev_rebalance_F12506  =   p_arrRebalanceDate[j].prev_F12506;
                        ...
                        /* 상장일이 이전 리밸런싱 일자 보다 큰 경우 */
                        if(     p_dailyJongmokObj[ p_param.F12506 ][ v_portKey ].F16017 <=  p_arrRebalanceDate[0].F12506        /* 상장일이 최초 리밸런싱일자보다 이전인 경우 */
                            ||  p_param.F12506 >=  p_dailyJongmokObj[ p_param.F12506 ][ v_portKey ].rebalance_F12506            /* 해당 일자가 리밸런싱일자보다 큰 경우 */
                        ) {
                            ...
                            /* 시가기준 시총 = 상장주식수(p_param.F16143) * 종가(p_param.F30700) */
                            p_dailyJongmokObj[ p_param.F12506 ][ v_portKey ].F15028_1   =   0;

                            /* 시가기준 시총 = 상장주식수(p_param.F16143) * 기준가(p_param.F15007) */
                            p_dailyJongmokObj[ p_param.F12506 ][ v_portKey ].F15028_2   =   0;
            ...
            /* total 정보 설정 */
                ...
                /* 시가기준 시총 누적 - 현재가 */
                totalInfo.tot_F15028_3                  =       Number( totalInfo.tot_F15028_3 ) 
                                                            +   Number( p_dailyJongmokObj[ p_param.F12506 ][ v_portKey ].F15028_3 );                                                            
                    ...
                    **************************************************************************************************************/
                    if( [ "1", "2" ].includes( totalInfo.importance_method_cd ) ) {
                        ...
                        p_dailyJongmokObj[ p_param.F12506 ][ krwInfo.F16013 ].F15028_2   =   fn_calc_data( 
                         ...
                         /* 시가기준 시총 = 상장주식수(p_param.F16143) * 현재가(p_param.F15001) */
                         p_dailyJongmokObj[ p_param.F12506 ][ krwInfo.F16013 ].F15028_3   =   fn_calc_data( 
                            "F15028_3"
                            ,   {       
                                        F15001  :   p_dailyJongmokObj[ p_param.F12506 ][ krwInfo.F16013 ].F15001        /* 현재가  */
                                    ,   F16143  :   p_dailyJongmokObj[ p_param.F12506 ][ krwInfo.F16013 ].F16143        /* 상장주식수 */
                                } 
                        );
                    ...
                    /* total 정보 *    
                        ...
                        /* 시가기준 시총 누적 - 현재가 */
                        totalInfo.tot_F15028_3                  =       Number( totalInfo.tot_F15028_3 ) 
                                                                    +   Number( p_dailyJongmokObj[ p_param.F12506 ][ krwInfo.F16013 ].F15028_3 );

                        /* 현재가 총합*/
                        totalInfo.tot_F15001                  =       Number( totalInfo.tot_F15001 ) +   Number( p_dailyJongmokObj[ p_param.F12506 ][ krwInfo.F16013 ].F15001);
                    }
                }
            }
        ...
        try{
            ...
            for( var i = 0; i < Object.keys( p_dailyJongmokObj[ p_param.F12506 ] ).length; i++ ) {
                ...
                **************************************************************************************************************/
                ...
                if( [ "2" ].includes( v_dataItem.importance_method_cd ) ) {
                    /* 기준가(p_param.F15001) * 상장주식수(p_param.F16143) */
                    v_dataItem.F15001_F16143            =   fn_calc_data( 
                            "F15001_F16143"
                        ,   {       
                                    F15001          :   v_dataItem.F15001               /* 수정가  */
                    ...
                    /* 기준 시가총액 = 수정가(p_param.F15001) * 상장주식수(p_param.F16143) * 지수적용비율(p_param.TODAY_RATE) */
                    ...
                    v_dataItem.F15028_C         =   fn_calc_data( 
                            "F15028_C_1"
                        ,   {       
                                    F15001          :   v_dataItem.F15001               /* 수정가 ( 당일 종가 ) - 종가 */
                                ,   F16143          :   v_dataItem.F16143               /* 상장주식수 */
                                ,   TODAY_RATE      :   v_dataItem.TODAY_RATE           /* 지수적용비율 */
                            }
                        ,   {}
                ...
                /* 수정가 * 상장주식수 총액 */
                eventObj.tot_F15001_F16143      =       Number( eventObj.tot_F15001_F16143 )
                                                    +   Number( v_dataItem.F15007_F16143 );                                                    
            }
            ...
            /* 기준가 * 상장주식수 총액 */
            p_dailyObj[ p_param.F12506 ].tot_F15001_F16143     =   eventObj.tot_F15001_F16143;
        ...
        try{
            ...
            for( var i = 0; i < Object.keys( p_dailyJongmokObj[ p_param.F12506 ] ).length; i++ ) {
                ...
                if( p_param.first_oper_yn    ==  "Y" ) {
                    ...
                    v_dataItem.F15028                           =   v_dataItem.F15028_3;
                    p_dailyObj[ p_param.F12506 ].tot_F15028     =   p_dailyObj[ p_param.F12506 ].tot_F15028_3;


                    /* 지수 적용 비율 = 비중 * SUM( 직전 영업일 종가 총합) / 종목 직전영업일 종가*/
                    v_dataItem.TODAY_RATE           =       fn_calc_data( 
                                "TODAY_RATE1"
                            ,   {       
                                        importance      :   v_dataItem.importance                           /* 비중 */
                    ...
                    /* 기준 시가총액 = 현재가(p_param.F15001) * 상장주식수(p_param.F16143) * 지수적용비율(p_param.TODAY_RATE) */
                    v_dataItem.F15028_S         =   fn_calc_data(
                            "F15028_S_3"
                            ,   {       
                                        F15001      :   v_dataItem.F15001               /* 기준가 ( 전일 종가 ) - 기준가 */
                                    ,   F16143      :   v_dataItem.F16143               /* 상장주식수 */
                                    ,   TODAY_RATE  :   v_dataItem.TODAY_RATE           /* 지수적용비율 */
                                }
                            ,   {}
                    ...
                    /* 직전 영업일 기준 시총과 같다. */
                    v_dataItem.F15028_C         =   v_dataItem.F15028_S
                        ...
                        if( p_param.first_record_yn == "Y" ) {
                            ...
                            try {
                                ...
                                v_dataItem.F15028_S         =   fn_calc_data(
                                        "F15028_S_3"
                                        ,   {       
                                                    F15001      :   p_firstHistObj[ p_param.v_before_F12506 ][v_dataKey].F15001               /* 기준가 ( 전일 종가 ) - 기준가 */
                                                ,   F16143      :   p_firstHistObj[ p_param.v_before_F12506 ][v_dataKey].F16143               /* 상장주식수 */
                                                ,   TODAY_RATE  :   p_firstHistObj[ p_param.v_before_F12506 ][v_dataKey].TODAY_RATE           /* 지수적용비율 */
                                            }
                                        ,   {}
                                );
                            ...
                            try {
                                    ...
                                    v_dataItem.TODAY_RATE           =       fn_calc_data( 
                                            ...
                                            ,   {       
                                                        importance      :   v_dataItem.importance                           /* 비중 */
                                                    ,   F15028          :   p_dailyJongmokObj[ p_param.v_before_F12506 ][v_dataKey].F15028_3                               /* 시가기준 시총 */
                                                }
                                            ,   {       
                                                        tot_F15028      :   p_dailyObj[ p_param.v_before_F12506 ].tot_F15001       /* 현재가 총합 */
                                                }
                                    ...
                                    /* 기준 시가총액 = 전일현재가(p_param.F15001) * 상장주식수(p_param.F16143) * 지수적용비율(p_param.TODAY_RATE) */
                                    v_dataItem.F15028_S         =   fn_calc_data(
                                        "F15028_S_3"
                                        ,   {       
                                                    F15001      :   p_dailyJongmokObj[ p_param.v_before_F12506 ][v_dataKey].F15028_3               /* 기준가 ( 전일 종가 ) - 기준가 */
                                                ,   F16143      :   v_dataItem.F16143               /* 상장주식수 */
                                                ,   TODAY_RATE  :   v_dataItem.TODAY_RATE           /* 지수적용비율 */
                                            }
                                        ,   {}
                ...
                if( p_dailyObj[ p_param.F12506 ].rebalancing    ==  "1" ) {
                    ...
                    // 리밸런싱일 이후 기준 시가 총액은 다음 리밸런싱일까지 같음 
                    if( p_param.first_oper_yn    !=  "Y" ) {
                        if (i == Object.keys( p_dailyJongmokObj[ p_param.F12506 ] ).length - 1 && totalInfo.tot_F15028_S != Number(p_dailyObj[ p_param.v_before_F12506].tot_F15028_S)) {                           
                            totalInfo.tot_F15028_S = Number(p_dailyObj[ p_param.v_before_F12506].tot_F15028_S);
                        } 
                    }
                }
        ...
        try{
            ...
            switch ( p_gubun ) {
                ...
                case    "F15007_F16143"  :
                        ...
                        /* 수정가(p_param.F15001) * 상장주식수(p_param.F16143) */
                case    "F15001_F16143"   :
                            v_calc  =   Number( p_param.F15001 )  *  Number( p_param.F16143 );
                            if (isNaN(v_calc)) v_calc = 0;
                            break;                            
                ...
                case    "F15028_C"    :
                        ...
                        /* 비교 시가총액 =  수정가(p_param.F15001) * 상장주식수(p_param.F16143) * 지수적용비율(p_param.TODAY_RATE) */
                case    "F15028_C_1"    :
                            v_calc  =   Number( p_param.F15001 )  *  Number( p_param.F16143 ) *  Number( p_param.TODAY_RATE );
                            if (isNaN(v_calc)) v_calc = 0;
                            break;                            
