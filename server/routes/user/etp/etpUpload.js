                ...
                if( dataLists.length == 1 ) {
                    ...
                    for (var i = 0; i < dataLists.length-1; i++) {
                        ...
                        if( data.col01 != paramData.F16012 ) {
                            ...
                            data.result             =   false;
                            data.msg                =   "[" + ( i + v_param.p_startIndex + 1 ) + " 행] ETF 코드 컬럼이 현재 ETF 코드와 다릅니다.";
                        }
                        ...
                        if( i == dataLists.length-2 ) {
                            ...
                            if( data.col01 != paramData.F16012 ) {
                                ...
                                data.result             =   false;
                                data.msg                =   "[" + ( data.row_no ) + " 행] ETF 코드 컬럼이 현재 ETF 코드와 다릅니다.";
                            }                            
                        }
                    }
                }
