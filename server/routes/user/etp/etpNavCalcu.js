    ...
    Promise.using(pool.connect(), conn => {
      async.waterfall([
        function(callback) {
          ...
          var stmt = mapper.getStatement('etpDetail', 'getEtpBasic', params, {
            language: 'sql',
            indent: '  '
          });
        ...
        function(etpBasic, callback) {
          ...
          var stmt = mapper.getStatement('etpNav', query_id, params, {
            language: 'sql',
            indent: '  '
          });
          log.debug("stmt:" + stmt);
...
var getiNavIndexData = function(req, res) {
  try {
    ...
    var stmt = mapper.getStatement('etpDetail', 'getEtpBasic', options, {
      language: 'sql',
      indent: '  '
    });
    // 대입 연산자 치환
...
var getExchBasic = function(req, res) {
  try {
    ...
    log.debug("options", JSON.stringify(options));
    var stmt = mapper.getStatement('etpOper', 'getExchBasic', options, {
      language: 'sql',
      indent: '  '
    });
    // 대입 연산자 치환
...
var getKspjongBasic = function(req, res) {
  try {
    ...
    log.debug("options", JSON.stringify(options));
    var stmt = mapper.getStatement('etpOper', 'getKspjongBasic', options, {
      language: 'sql',
      indent: '  '
    });
    // 대입 연산자 치환
...
var getFutureBasic = function(req, res) {
  try {
    ...
    */
    ...
    log.debug("options", JSON.stringify(options));
    var stmt = mapper.getStatement('etpOper', 'getFutureBasic', options, {
      language: 'sql',
      indent: '  '
    });
    // 대입 연산자 치환
...
var getBondBasic = function(req, res) {
  try {
    ...
    log.debug("options", JSON.stringify(options));
    var stmt = mapper.getStatement('etpOper', 'getBondBasic', options, {
      language: 'sql',
      indent: '  '
    });
    // 대입 연산자 치환
