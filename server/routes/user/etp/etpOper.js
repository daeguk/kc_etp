              ...
              if(rows && rows.length > 0) {
                for(var i in resultMsg.dataList) {
                  var same = rows.filter(function(o, p) {
                    return (o.F12506 === resultMsg.dataList[i].F12506 /* 일자 */ && o.F16583 === resultMsg.dataList[i].F16583 /* 사무수탁회사번호 */ && o.F16012 === resultMsg.dataList[i].F16012 /* ETF종목코드 */ && o.F16013 === resultMsg.dataList[i].F16013 /* ETF단축코드 */ && o.F16316 === resultMsg.dataList[i].F16316 /* 구성종목코드 */ );
                  });
                  if(same.length == 1) {
              ...
              conn.query(stmt, function(err, rows) {
                ...
                if(rows && rows.length > 0) {
                  for(var i in resultMsg.allDataList) {
                    ...
                    var same = rows.filter(function(o, p) {
                      return (o.F16583 === resultMsg.allDataList[i].F16583 /* 사무수탁회사번호 */ && o.F16012 === resultMsg.allDataList[i].F16012 /* ETF종목코드 */ && o.F16013 === resultMsg.allDataList[i].F16013 /* ETF단축코드 */ );
                    });
                    if(same.length > 0) {
    ...
    Promise.using(pool.connect(), conn => {
      async.waterfall([
        ...
        function(msg, callback) {
          try {
            /* ETF 인 경우 - ETP상품구분코드(1:ETF(투자회사형),2:ETF(수익증권형),3:ETN,4:손실제한형ETN) */
            if(resultMsg.etpBasic && (resultMsg.etpBasic.F16493 == "1" || resultMsg.etpBasic.F16493 == "2")) {
                ...
                async.waterfall([
                  ...
                  function(callback) {
                    try {
                      ...
                      arrInsertDtl = [];
                      arrModifyDtl = [];
                      var stmt = mapper.getStatement('etpOper', 'getTdEtfpdfBasicExistsCheck', paramData, {
                        language: 'sql',
                        indent: '  '
                      });
                      logg.debug(stmt);
                  ...
                  function(msg, callback) {
                    try {
                      if(arrInsertDtl && arrInsertDtl.length > 0) {
                        ...
                        var stmt = mapper.getStatement('etpOper', 'saveTdEtfpdfBasic', paramData, {
                          language: 'sql',
                          indent: '  '
                        });
                        logg.debug(stmt);
                  ...
                  function(msg, callback) {
                    try {
                      if(arrModifyDtl && arrModifyDtl.length > 0) {
                        ...
                        var stmt = mapper.getStatement('etpOper', 'modifyTdEtfpdfBasic', paramData, {
                          language: 'sql',
                          indent: '  '
                        });
                        logg.debug(stmt);
                  ...
                  function(msg, callback) {
                    try {
                      ...
                      arrModifyDtl = [];
                      paramData.dataLists = subList.data;
                      var stmt = mapper.getStatement('etpOper', 'getTdEtfpdfHistExistsCheck', paramData, {
                        language: 'sql',
                        indent: '  '
                      });
                      logg.debug(stmt);
                  ...
                  function(msg, callback) {
                    try {
                      if(arrInsertDtl && arrInsertDtl.length > 0) {
                        paramData.dataLists = arrInsertDtl;
                        var stmt = mapper.getStatement('etpOper', 'saveTdEtfpdfHist', paramData, {
                          language: 'sql',
                          indent: '  '
                        });
                        logg.debug(stmt);
                  ...
                  function(msg, callback) {
                    try {
                      if(arrModifyDtl && arrModifyDtl.length > 0) {
                        paramData.dataLists = arrModifyDtl;
                        var stmt = mapper.getStatement('etpOper', 'modifyTdEtfpdfHist', paramData, {
                          language: 'sql',
                          indent: '  '
                        });
                        logg.debug(stmt);
                  ...
                  function(msg, callback) {
                    try {
                      ...
                      arrModifyDtl = [];
                      paramData.dataLists = subList.data;
                      var stmt = mapper.getStatement('etpOper', 'getTmPdfModifyDtlExistsCheck', paramData, {
                        language: 'sql',
                        indent: '  '
                      });
                      logg.debug(stmt);
                  ...
                  function(msg, callback) {
                    try {
                      if(arrInsertDtl && arrInsertDtl.length > 0) {
                        paramData.dataLists = arrInsertDtl;
                        var stmt = mapper.getStatement('etpOper', 'saveTmPdfModifyDtl', paramData, {
                          language: 'sql',
                          indent: '  '
                        });
                        logg.debug(stmt);
                  ...
                  function(msg, callback) {
                    try {
                      if(arrModifyDtl && arrModifyDtl.length > 0) {
                        paramData.dataLists = arrModifyDtl;
                        var stmt = mapper.getStatement('etpOper', 'modifyTmPdfModifyDtl', paramData, {
                          language: 'sql',
                          indent: '  '
                        });
                        logg.debug(stmt);
                  ...
                  function(msg, callback) {
                    try {
                      var stmt = mapper.getStatement('etpOper', 'getTmPdfModifyMastCheck', paramData, {
                        language: 'sql',
                        indent: '  '
                      });
                      logg.debug(stmt);
                  ...
                  function(msg, callback) {
                    ...
                    try {
                      ...
                      var stmt = mapper.getStatement('etpOper', queryId, paramData, {
                        language: 'sql',
                        indent: '  '
                      });
                      logg.debug(stmt);
                  ...
                  function(msg, callback) {
                    try {
                      var stmt = mapper.getStatement('etpOper', 'saveTmPdfModifyHistMast', paramData, {
                        language: 'sql',
                        indent: '  '
                      });
                      logg.debug(stmt);
  ...
  try {
    for(var i = 0; i < fsData.allDataList.length; i++) {
      ...
      for(var j = 0; j < tmp.data.length; j++) {
        ...
        var ostr = wItem.fld000 + wItem.fld001 + wItem.fld002 + wItem.fld003 + wItem.fld004 + wItem.fld005 + wItem.fld006 + wItem.fld007 + wItem.fld008 + wItem.fld009 + wItem.fld010 + wItem.fld011 + wItem.fld012 + wItem.fld013 + wItem.fld014 + wItem.filler + wItem.filler2;
              ...
              conn.query(stmt, function(err, rows) {
                ...
                if(rows && rows.length > 0) {
                  for(var i in resultMsg.allDataList) {
                    ...
                    resultMsg.allDataList[i].etf_F16583 = resultMsg.allDataList[i].F16583; /* ETF 사무수탁회사번호 */
                    var same = rows.filter(function(o, p) {
                      return (o.hist_no === resultMsg.allDataList[i].hist_no /* 이력번호 */ && o.email === resultMsg.allDataList[i].email /* 이메일 */ && o.F16583 === resultMsg.allDataList[i].F16583 /* 사무수탁회사번호 */ && o.F16012 === resultMsg.allDataList[i].F16012 /* ETF종목코드 */ && o.F16013 === resultMsg.allDataList[i].F16013 /* ETF단축코드 */ && o.group_no === resultMsg.allDataList[i].group_no /* 사용자별 처리한 그룹번호 */ );
                    });
                    if(same.length > 0) {
                      resultMsg.allDataList[i].data = [];
                      resultMsg.allDataList[i].data = same;
