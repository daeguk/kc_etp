...
//        { file: './user/index/indexmanage', path: '/user/index/getIndexToastGridTestList', method: 'getIndexToastGridTestList', session: 'uncheck', type: 'get' },
        ...
        { file: './user/simulation/simulation'          , path: '/user/simulation/applyShareUser'               , method: 'applyShareUser'                  , session: 'check', type: 'post' },     // 공유 대상자 적용
        { file: './user/simulation/simulation'          , path: '/user/simulation/applyShareUserRevoke'         , method: 'applyShareUserRevoke'            , session: 'check', type: 'post' },     // 공유 대상자 해제
