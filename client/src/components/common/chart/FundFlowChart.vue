...
export default {
  ...
  methods: {
    drawChart: function() {
      ...
      if(   typeof this.sitem != "undefined" 
        &&  typeof this.eitem != "undefined"
        &&  typeof this.citem != "undefined"

        &&  typeof this.sitem.FLOW != "undefined" 
        &&  typeof this.eitem.FLOW != "undefined" 
        &&  typeof this.citem.FLOW != "undefined" 
      ) {
        var c = this.ctx;
        var rad = 30;
        var cX1 = 60;
