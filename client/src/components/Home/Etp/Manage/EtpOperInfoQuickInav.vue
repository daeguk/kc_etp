        ...
        <v-layout row wrap>
            <v-flex xs12>
                <v-tabs slot="extension" v-model="tab" align-with-title light>
                    ...
                    <v-tab v-for="item in items4" :key="item">{{ item }}</v-tab>
                </v-tabs>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="txt_right">
                                                277166.42
                                                <br>
                                                <span class="text_S text_red">0.14%</span>
                                            </td>
                                            <td class="txt_right">
                                                273.00
                                                <br>
                                                <span class="text_S">2018.10.19</span>
                                            </td>
                                            <td class="txt_right">
                                                1129.30
                                                <br>
                                                <span class="text_S">USDKRW</span>
                                            </td>
                                            <td>
                                                            ...
                                                            <v-card flat class="sumul_card_w">
                                                                <v-layout>
                                                                    <v-flex xs12>
                                                                        ...
                                                                        <ul>
                                                                            <li
                                                                                class="list_tit case2 txt_point"
                                                                            >전일NAV</li>
                                                                            <li class="input_mid">
                                                                                <v-text-field
                                                                                    value
                                                ...
                                                <v-flex xs12>
                                                    <v-card flat>
                                                        ...
                                                        >
                                                            ...
                                                            <v-card
                                                                class="pop_btn_w text-xs-center"
                                                            >
                                                                <v-btn
                                                                    depressed
                                                                    color="primary"
