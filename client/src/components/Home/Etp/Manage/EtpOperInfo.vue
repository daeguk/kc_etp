...
export default {
    ...
    data() {
        return {
            ...
            columnState :   'etpInfo',      /* etpInfo-ETP운용정보, iNav-iNav 산출현황, customize-컬럼 선택 */
            arrColumn   :   [],
            arrShowColumn   :   [],
    ...
    mounted: function() {
        ...
        vm.arrColumn  =   [
            ...
            { 'name' : 'index_cal_method'   , 'data': 'index_cal_method' ,  'width' : '80',  'orderable' : true  , 'className': 'dt-body-left',  'title' : '지수산출방식'   },      /* 지수산출방식 */
            ...
            { 'name' : 'graph'              , 'data': null               ,  'width' : '80', 
              'defaultContent' :    '<div class="tooltip">'
                                        /* ETF 상세정보 */
                                +       '<button    id="btnEtpInfo" '
                                +       '           type="button" '
                                +       '           class="btn_icon v-icon material-icons" '
                                +       '>equalizer</button>'
                                +       '<span class="tooltiptext" style="width:70px;">ETP정보</span>'
...
*/            
    ...
    methods: {
        ...
        fn_getEtpOperInfo( gubun ) {
            ...
            if( !gubun ) {
                gubun   =   "A";        /* A-전종목, K-국내, F-해외, I-관심종목 */
            }
        ...
        fn_setArrShowColumn( arrTemp ) {
            ...
            if( vm.arrShowColumn.length > 0 && vm.arrColumnDef.length > 0 ) {
                vm.arrShowColumn.forEach(function(e,i) {
                    var same = vm.arrColumnDef.filter(function(o, p) {
