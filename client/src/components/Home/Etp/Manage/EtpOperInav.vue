                                                ...
                                                <v-layout>
                                                 ...
                                                 <v-layout>
                                                     <v-flex xs12 class="sumul_card_w ver3">
                                                        ...
                                                        <ul class="bot_line2">
                                                            <li class="list_tit"><b>지수기준가</b><br><span>기준일</span></li>
                                                            <li><div><v-text-field value outline class="txt_right"></v-text-field><span class="float_r">2018.10.11</span></div></li>
                                                        </ul>
                                                        <ul>
                                                            <li class="list_tit txt_point">등락률(%)</li>
                                                            <li class="align_r"><b>0.98</b></li>
                                                        </ul>
                                                        </v-flex>
                                                 </v-layout>
                                                 <v-layout>
                                                     <v-flex xs12 class="sumul_card_w ver3">
                                                        ...
                                                        <ul>
                                                         ...
                                                         <ul class="bot_line3">
                                                            ...
                                                            <li class="align_r"><b>-</b></li>
                                                        </ul>
                                                        <ul class="result">
                                                            <li class="list_tit txt_point1">iNAV 계산결과</li>
                                                             <li class="align_r text_red"><b>12435.13</b><br><span class="float_r">0.58%</span></li>
                                                        </ul>
                                                        </v-flex>
                                                 </v-layout>
