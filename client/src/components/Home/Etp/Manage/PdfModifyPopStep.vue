<template>
    <v-dialog v-model="dialog5" persistent max-width="900">
        ...
        <v-card class="mx-auto">
            <v-window v-model="step">
                <v-window-item :value="1">
                    ...
                    <v-card flat class="listset_pop">
                        <h5>
                            <v-card-title ma-0>
                                TIGER 코스닥 150 <span>229200</span>
                                <v-spacer></v-spacer>
                        ...
                        <table id class="tbl_type" style="width:100%">
                            ...
                            <tbody>
                                <tr class="pdfmody_acttd">
                                    <td></td>
                                    <td></td>
                                    <td colspan='6' class="txt_left"><input type="text" class="txt_left width_fix" placeholder="12자리/6자리코드"> <button type='button' class='v-btn v-btn--outline v-btn--small v-btn--depressed btn_intable_01' v-on='on'>확인</button>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="txt_right"><input type="text" class="txt_right"></td>
            ...
            <v-card-actions>
                ...
                <v-window-item :value="2">
                    ...
                    <v-card flat class="listset_pop">
                        <h5>
                            <v-card-title ma-0><v-btn icon :disabled="step === 1" flat @click="step--"><v-icon>arrow_back_ios</v-icon></v-btn> PDF 변경신청 현황
                                <v-spacer></v-spacer>
                                <v-btn icon @click="dialog5 = false"><v-icon>close</v-icon></v-btn>
                            </v-card-title>
                        </h5>
                        <v-card flat>
                        <table id class="tbl_type" style="width:100%">
                    ...
                    <v-card flat class="pdf_context">
                        ...
                        <div class="pop_btn_w">
                        <p class="pdfmody_btn">
                            <v-btn fab dark depressed color="primary" @click="all"><v-icon dark large>add</v-icon></v-btn>네, 추가 변경 작업을 진행합니다.
                            <v-expansion-panel v-model="panel" expand>
                              <v-expansion-panel-content flat>
                                  <v-card flat>
                                    <v-card-text>
                                        <div class="pdfmody_panel">
                                            <span><v-text-field placeholder="ETP의 종목코드 12자리 또는 단축코드를 입력하세요" value outline class="width_fix2"></v-text-field></span>
                                            <span><v-btn outline small color="primary"> 확인</v-btn><v-btn outline small color="#9e9e9e"> 취소</v-btn></span>
                                        </div>
                                    </v-card-text>
                                  </v-card>
                        ...
                        <p class="pdfmody_btn"><v-btn fab dark depressed color="primary" @click="step++"><v-icon dark large>navigate_next</v-icon></v-btn>아니오, 지금까지 변경한 내용을 제출합니다.</p>
                        </div>
                    </v-card>
                </v-card>
                <v-divider></v-divider>
            ...
            <v-card-actions>
                ...
                <v-window-item :value="3">
                    ...
                    <v-card flat class="listset_pop">
                        ...
                        <v-card flat>
                        <h4>TIGER 코스닥 150 <span>002345</span></h4>
                        <table id class="tbl_type" style="width:100%">
                            <colgroup>
                                <col width="15%">
                                <col width="20%">
                        ...
                        <h4>TIGER 레버러지 <span>002345</span></h4>
                        <table id class="tbl_type" style="width:100%">
                            <colgroup>
                                <col width="15%">
                                <col width="20%">
                    ...
                    <v-card flat class="pdf_context">
                        <div class="pdf_coment text-xs-center text_blue"><b>PDF 변경 신청이 완료되었습니다.<br>
                        신속한 작업을 위해 내역을 제출하신 후 코스콤 담당자와 통화해주세요</b></div>
                        <div class="pdf_coment text-xs-center">신일식 과장 767-0000<br>
                        이형준 과장 767-0000<br>
                        오춘교 대리 767-0000</div>
                        <p class="text-xs-center"><v-btn dark depressed color="primary" @click="dialog5 = false" >닫기</v-btn></p>
                    </v-card>
                </v-card>
                <v-card-actions>
                </v-card-actions>
