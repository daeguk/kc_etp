            ...
            <v-card flat>
                ...
                <div class="incode_pop pb-3">
                    <ul>
                        ...
                        <li class="pt-3 text_red"><b>※ 주의사항</b><br>일괄제출시 이전의 PDF내역은 모두 지워지고, 제출한 엑셀내용으로 교체되므로 사용시 유의바랍니다.</li>
                    </ul>
                    ...
                    <div class="mt-3">
                        ...
                        <v-btn color="primary" depressed small class="ml-0 mb-3" >샘플 받기</v-btn>
                ...
                <ul>
                        <li class="pt-3"><b>1. 필수 입력사항:</b> <br>
                        (1) ETF 종목코드(12자리), <br>
                        (2) 구성종목코드(12자리),<br>
                        (3)  CU수량 OR 액면금액<br>
                         * 단축코드는 사용불가합니다.<br>
                         * 종목명은 선택사항입니다.</li>
                        <li class="pt-3"><b>2. 원화예금(현금)</b>의 ISIN코드는 <b>'KRD010010001'</b>로 입력하세요</li>
                        <li class="pt-3"><b>3. 채권</b>종목의 경우 <b>'액면금액'</b> 컬럼에 값을 입력하세요<br>
  - 이경우, 'CU당수량' 컬럼은 '0' 값입력 또는 공란으로 비워두세요</li>
                        <li class="pt-3 pb-3"><b>4.</b> 주식, 선물 등 <b>채권외</b>종목의 경우 <b>'CU당수량'</b> 컬럼에 값을 입력하세요.<br>
  - 이경우, '액면금액' 컬럼은 '0' 값 입력 또는 공란으로 비워두세요<br>
   * CU당수량값은 <b>소수점 둘째자리</b>까지 반영됩니다.</li>
                    </ul>
