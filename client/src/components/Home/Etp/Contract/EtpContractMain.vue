            ...
            if(!$.fn.dataTable.isDataTable('#jisu_grid')) {
              jisu_grid = $('#jisu_grid').DataTable({
                ...
                columns: [{
                  ...
                  "data": "CU",
                  "orderable": true,
                  defaultContent: "<input type='number' name='calcu' id='calcu'>"
                }, {
                  "data": null,
                  "orderable": true,
                  defaultContent: "<div class='tooltip'><button type='button' id='btn_context' class='btn_icon v-icon material-icons'>equalizer</button><span class='tooltiptext' style='width:40px;'>INDEX</span></div>"
                }, ]
              });
            }
          }
