...
<v-container>
    ...
    <v-card flat>
        ...
        <div>
         <h3 class="headline mb-0">Index List | <span class="grey--text"> total 363 index </span></h3>
        </div>
        </v-card-title>
    </v-card>
    <v-data-table
      ...
      <template slot="items" slot-scope="props">
        ...
        <td class="text-xs-center">
            <v-flex xs12 sm3 center>
                <v-btn flat icon color="blue" to="/index/manage/IndexListdetail" >
    ...
    <v-layout row wrap>
      <v-flex grow  ma-3>
        ...
        <v-card flat>
          <v-card-title primary-title>
        <div>
        <h3 class="headline mb-0">Index List | <span>total: 163 indexs</span></h3>
      </div>
    </v-card-title>
  </v-card>
