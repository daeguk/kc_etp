...
export default {
    ...
    methods: {
        ...
        movePage: function() {
            ...
            this.$router.push({path: '/index/manage/IndexDetailInfo', query :{'jisu_cd':this.chartItem.code, 'market_id':this.chartItem.market_id, 'large_type':this.chartItem.large_type}});
        }
    }
}
</script>
