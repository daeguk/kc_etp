...
<v-card flat xs12>
  <v-container>
    ...
    <v-flex xs2>
      ...
      <v-flex xs4 mt-3 mb-2>
        <span  class="text_color_blue" >등록완료 ></span> <span>연동신청 ></span> <span>연동완료 </span>
      </v-flex>
    </v-layout>
...
<div class="register_wrap">
      <v-card flat xs12  class="register_t_w">
         <h4>부가정보 <span class="text_color_blue">(선택)</span>
         <span class="subtitle_sub"><span style="color:red">플랫폼 연동</span> 신청을 위해서 지수방법론과 소급지수를 업로드하세요.</span> </h4>
        <v-container fluid>
