...
<v-dialog v-model="dialog" persistent max-width="510">
        <template v-slot:activator="{ on }">
              <v-btn  small flat icon class="simul_ticon mr-1" dark v-on="on" ><v-icon>help_outline</v-icon></v-btn>
        </template>
            <v-card flat>
                <h5>
                    <v-card-title>
                ...
                <div class="incode_pop">
                                ...
                                <table class="tbl_type ver11 v3">
                                    ...
                                    <colgroup>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:80%" class="txt_left"><span class="text_red">[필수입력]</span> 일자를 입력합니다(YYYMMDD).</td>
                                        </tr>
                                        <tr>
                                            <th>PRICE</th>
                                            <td class="txt_left"><span class="text_red">[필수입력]</span> 가격을 입력합니다.</td>
                                        </tr>
                                        </tbody>
                                </table>
                            </div>
                    ...
                    <div class="pb-4"><샘플 다운받기><v-btn color="primary" depressed small >양식 다운로드</v-btn></div>
